<?php
	...
	require_once("/root/openfire/REST api/Gidkom/OpenFireRestApi/GuzzleHttp/Client.php");
	...
	{
		public $host		= '192.168.1.151';
		public $port		= '9090';
		public $plugin		= '/plugins/restapi/v1';
		public $secret		= '8AfG5V0z5tzTdTmT';
		public $useSSL		= false;
		...
		private function doRequest($type, $endpoint, $params=array())
		{
			...
			echo $url = $base . "://" . $this->host . ":" .$this->port.$this->plugin.$endpoint;
			$headers = array(
