...
$(document).ready(function(){
	$("#btnsave").click(function(){	
	   $.ajax({
			url : "<?php echo site_url('letter/edit_validation')?>",
			type: "POST",
			data: $('#form').serialize(),
			dataType: "JSON",
                  ...
                  <div class="x_content">
                    ...
                    <strong id="susmsg"></strong>
					  ...
					  <form action="#" id="form" class="form-horizontal" method="post">	
						<?php foreach($get_letter_details->result() as $ltr){ ?>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">                          
						  ...
						  <input type="hidden" name="letter_id" value="<?php echo $ltr->Letter_id; ?>" >
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php 
							...
							echo form_dropdown('letter_category', $letter_cat, $ltr->Letter_category,'class = "form-control"');
						  ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php 
							...
							echo form_dropdown('letter_sort', $letter_sort, $ltr->Letter_sort,'class = "form-control"');
						  ?>
                        </div>
                      </div>
					 ...
					 <!-- test area -->
						<div class="form-group">
						    <div class="col-md-12">			  
							  <textarea name="description" id="editor1" rows="10" cols="80"><?php echo $ltr->Letter_description;?></textarea>
							</div>
						</div>
						<!-- test area -->
